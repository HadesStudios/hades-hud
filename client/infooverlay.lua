...
function RetrieveInfoOverlayComponents()
	InfoOverlay = exports["hades-base"]:FetchComponent("InfoOverlay")
end

AddEventHandler("Core:Shared:Ready", function()
	exports["hades-base"]:RequestDependencies("InfoOverlay", {
		"InfoOverlay",
	}, function(error)
		if #error > 0 then
			return
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["hades-base"]:RegisterComponent("InfoOverlay", INFOOVERLAY)
end)
