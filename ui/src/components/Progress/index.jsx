...
const useStyles = makeStyles((theme) => ({
    ...
    progressbarContainer: {
        padding: 5.3,
        border: '1px solid rgba(85, 180, 243, 0.5)',
        borderRadius: 4,
...
const ProgressBar = ({
    ...
    const BorderLinearProgress = withStyles((theme) => ({
        ...
        bar: {
            borderRadius: 2,
            backgroundColor: cancelled || failed ? "#6e1616" : '#005e8aff',
            boxShadow: cancelled || failed ? "0px 0px 10px 0px #6e161699" : '0px 0px 10px 0px #005e8aff',
        },
    }))(LinearProgress);
