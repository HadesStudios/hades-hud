...
export default withTheme(() => {
    ...
    const [statusStyle, setStatusStyle] = useState(hudConfig?.statusStyle || 'old');
    ...
    const handleStatusStyleChange = (event) => {
        ...
        <Dialog fullWidth maxWidth="sm" open={isShowing} className={classes.container}>
            <DialogContent className={classes.dialogContent}>
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12}>
                        <FormControl fullWidth variant="outlined">
                            <InputLabel>Status Style</InputLabel>
                            <Select value={statusStyle} onChange={handleStatusStyleChange} label="Status Style">
